package com.cim.procedure.mapper;
 ...
 * @date 2025-02-27
 */
public interface ProcedureItemMapper {
     ...
     * @return
     */
    public List<ProductProcedureInfo> getProduceItemListByProductCode(@Param("productCodes") List<String> productCodes);
}
